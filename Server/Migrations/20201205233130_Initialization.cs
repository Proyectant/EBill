        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    titleBill = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ransom = table.Column<double>(type: "float", nullable: false),
                    postingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    receiptDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    wayOfSelling = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bills", x => x.barcode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Billbarcode = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Products_Bills_Billbarcode",
                        column: x => x.Billbarcode,
